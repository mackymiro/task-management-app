                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($searchResults as $searchResult)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('taskController.edit', $searchResult->id) }}" class="btn btn-warning">Edit</a>
                                    |
                                    <form method="post" action="{{ route('taskController.destroy', $searchResult->id) }}" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
